...
module.exports = function(options) {
  ...
  return {
      "WaterFlow": require('./waterflow')(options)
    , "Parking": require('./parking')(options)
    , "StyrOchStall": require('./styrochstall')(options)
    , "TravelTime": require('./traveltime')(options)
    , "AirQuality": require('./airquality')(options)
  }
}